...
export default function ThemeToggle({ theme, onToggle }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className="relative w-7 h-7 rounded-full shrink-0 overflow-hidden
    ...
    >
      ...
      <svg
        ...
        fill="currentColor"
        aria-hidden="true"
        className={`absolute inset-0 m-auto w-3.5 h-3.5 text-indigo-200 transition-all duration-500 ease-out
